  ...
  <div id="app">
    <main class="container">
      <section class="intro">
        <h1>Image Palette</h1>
        <p>
          Generate a color palette from an image and automatically pair each color with a
          <a
        ...
        <p>
          ...
          <a
            href="https://github.com/akfish/node-vibrant/"
          >node-vibrant</a>, a Node.js implementation of
          <a
            href="https://developer.android.com/reference/android/support/v7/graphics/Palette.html"
          >Android's Palette class</a>.
          The contrasting color will be a color from the same palette if an accessible option is available.
          If not, it will be either black or white, depending on which one has a higher contrast ratio.
          In some rare instances, the resulting contrast ratio will be below the minimum threshold (4.5).
          These colors shouldn't be used with text in production.
        </p>
        <p>
          To get started, enter the URL to an image or press the random button to load an
          <a
        ...
        <div class="form-group">
          ...
          <div class="input-group mb-3">
            <input
              type="url"
              id="img-path"
              :class="['form-control', { 'is-invalid': inputFeedback }]"
            ...
            <div class="input-group-append">
              ...
              >Random Unsplash</button>
            </div>
            <!-- <div class="input-group-append">
              <button class="btn btn-primary" type="button" @click="loadRandomNorton">Random Norton</button>
            </div>-->
            <div class="invalid-feedback" id="input-feedback" v-html="inputFeedback"></div>
          </div>
        </div>
        ...
        <figure class="vibrant-figure" :style="dominantStyle">
          <div class="vibrant-img">
            <template>
              <img
                ...
                @load="processImage"
              >
              <placeholder-block v-else class="img-fluid" :dimensions="dimensions"/>
            </template>
          </div>
          ...
          <figcaption class="vibrant-caption">
            <p class="grid-align-start">
              ...
              Amet provident non totam quae numquam praesentium omnis ea dolorum.
              Dicta neque nostrum itaque modi consequuntur iusto non commodi labore repellendus et?
            </p>
            <button
              class="btn grid-justify-center grid-align-start"
              :style="inverseStyle"
              @click="copyLink"
            >Copy link to this palette</button>
          </figcaption>
        </figure>
